...
String succeedEditText = '수정사항이 저장되었습니다.';
String failureEditText = '이 데이터는 반려되었습니다!';
String notSaveEditText = '데이터가 저장되지 않았습니다.';
...
/// 데이터 수정 성공 popup
void showDataManageSucceedPopup(BuildContext context, Function()? onTap) {
  showPopup(context, succeedEditText, '확인', onTap: onTap);
}
...
/// 오류 발생 popup
void showErrorPopup(BuildContext context, {String? error}) {
  showDialog(
    context: context,
    barrierDismissible: false,
    builder: (BuildContext context) {
