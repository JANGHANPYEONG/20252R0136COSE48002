...
def get_csv_structure():
    ...
    return {
        ...
        "label_end_index": column_config["column_order"]["label_end_index"],
        ...
        "total_columns": ["id"] + column_config["label_columns"] + spectral_cols
    }
...
def get_label_columns(data):
    ...
    end_idx = column_config["column_order"]["label_end_index"] + 1
...
if __name__ == "__main__":
    ...
    print(f"Label Range: {structure['label_start_index']}-{structure['label_end_index']}")
