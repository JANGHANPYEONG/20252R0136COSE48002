...
from app.routers import train, predict, meat, user, statistic_api, data, xai, hsi_predict, hsi_train, list_data
...
app.include_router(list_data.router, prefix="/list-data", tags=["list-data"])  # 데이터 관련 API, test 용 추가
